...
<div class="bg-1">
 ...
 <center>
  ...
  $query2 = "SELECT * FROM booking INNER JOIN detail_booking ON booking.booking_id = detail_booking.booking_id WHERE booking.id_customer = '$_SESSION[id_customer]' AND detail_booking.id_detail AND booking.booking_id = '$id'"; // Query untuk menampilkan semua data siswa
 ...
 ?>
  ...
  <table class="table">
<h2>DETAIL BOOKING LAYANAN & PERAWATAN</h2>
<tr><th><center>Nama Lengkap<td><?php echo $_SESSION['nama_lengkap']; ?></center></td></tr>
<tr><th><center>Layanan & Perawatan<td><?php echo $data2['nama_layananperawatan']; ?></center></td></tr>
<tr><th><center>Tanggal Booking<td><?php echo $data2['tanggal_booking']; ?></center></td></tr>
<tr><th><center>Tanggal Bayar<td><?php echo $data2['tanggal']; ?></center></td></tr>
<tr><th><center>Status Pembayaran<td><span class="badge badge-pill badge-success"><?php echo $data2['status_bayar']; ?></span></center></td></tr>


<tr><th><center>Bukti Struk<td><?php
                                                                        if($data2['gambar']){ ?>
                                                            <a target="_blank" href="php/gambar/<?php echo $data2['gambar'] ?>">
                                                                        <img src="php/gambar/<?php echo $data2['gambar'] ?>" width="120px" height="150px"></a> </center><br>
                                                                        <?php } else { ?>
                                                                            <a target="_blank" href="gambar/perusahaan1.png">
                                                                        <img src="php/gambar/" width="150px" height="100px"></a> </center>
                                                                        <?php } ?> </td></tr>
</table>
  </center>
