  ...
  <header>
    <div class="main">
      ...
      <nav class="nav-sub-pages">
        <ul class="menu">
  <li class="current" style="width:180px;"><a href="home.php">Home</a></li>
        <li style="width:180px;"><a href="layanan_perawatan.php" >Layanan & Perawatan</a></li>
	   <li style="width:180px;"><a href="promo.php">Promo</a></li>
	   <li style="width:180px;"><a href="booking.php">Data Booking</a></li>
    ...
    <div class="">
      <div class="bg-6 bot-1">
        <div class="container_24">
          <div class="grid_24">
            <div class="line"></div>
            <div class="font-1 pad-2">Promo Maria Beauty Salon</div>
          </div>
		    <?php
            
             if(isset($_GET['search'])){
           $strQuery = "SELECT Id_promo, Id_layananperawatan, booking_status, nama_layananperawatan, harga_awal, harga_promo, mulai_promo, batas_promo, gambar
                    FROM promo 
                    WHERE Id_promo
          ...
          <div class="grid_7 box-2">
            ...
            <h3>   <?php echo "<a href=# data-toggle=modal data-target=#detail$i>$result[nama_layananperawatan]</a>";?></h3>
			 <center><b>Tanggal Promo Dari <?php
                                                        echo "$result[mulai_promo]";
                                                    ?>  Sampai    <?php
                                                        echo "$result[batas_promo]";
                                                    ?></b><br></center>
            <div class="img-border"> <a href="../admin/gambar_promo/<?php echo $result['gambar'] ?>">
                                    <?php if($result['gambar']){ ?>
                                       
                                        <img src="../admin/gambar_promo/<?php echo $result['gambar'] ?>" width="100%" height="200px">
                                    <?php } else { ?>
                                        <img src="#" width="270px" height="200px">
                                    <?php } ?>
                                    </a></div>
									<center><b>Harga: <s style="font-color:red;">Rp. <?php
                                                        echo "$result[harga_awal]";
                                                    ?></s>     ||   Rp. <?php
                                                        echo "$result[harga_promo]";
                                                    ?></b><br></center>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <center>
                                                        <?php
                                                        if($result['gambar']){ ?>
                                            <a href="../admin/gambar_promo/<?php echo $result['gambar'] ?>">
                                                        <img src="../admin/gambar_promo/<?php echo $result['gambar'] ?>" width="300px" height="400px"></a> </center><br>
                                                        <?php } else { ?>
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <input type="hidden" name="id_layananperawatan" value="<?php echo $result['id_layananperawatan'];?>"/>
													...
													<input type="hidden" name="harga" value="<?php echo $result['harga_awal'];?>"/>
													 <input type="hidden" name="tanggal" value="<?php echo date("Y-m-d"); ?>">
													 <input type="hidden" name="harga_promo" value="<?php echo $result['harga_promo'];?>"/>
